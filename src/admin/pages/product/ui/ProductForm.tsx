...
import type { Product, Size } from '@/interface/product.interface';
...
interface Props {
    ...
    // Methods
    onSubmit: (productLike: Partial<Product> & { files?: File[] }
    ) => Promise<void>;
};
                                    ...
                                    {availableSizes.map((size) => (
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                className='bg-slate-200 text-slate-700 hover:bg-slate-300 cursor-pointer'
                                            >
                                                <X className="h-3 w-3" />
                                            </button>
                                        </span>
